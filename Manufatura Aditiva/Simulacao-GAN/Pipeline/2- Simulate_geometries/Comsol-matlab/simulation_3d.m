function [out,E] = simulation_3d(array,theta)
...
model.component('comp1').geom('geom1').feature('wp1').geom.feature('arrec1').set('fullsize', [3 3]);
...
model.component('comp1').geom('geom1').feature('wp1').geom.create('arrec2', 'Array');
model.component('comp1').geom('geom1').feature('wp1').geom.feature('arrec2').set('fullsize', [2 2]);
model.component('comp1').geom('geom1').feature('wp1').geom.feature('arrec2').set('displ', {'arrange_size' '0'});
model.component('comp1').geom('geom1').feature('wp1').geom.feature('arrec2').setIndex('displ', 'arrange_size', 1);
model.component('comp1').geom('geom1').feature('wp1').geom.feature('arrec2').selection('input').set({'uni2'});
model.component('comp1').geom('geom1').feature('wp1').geom.run('arrec2');

model.component('comp1').geom('geom1').feature('wp1').geom.create('uni3', 'Union');
model.component('comp1').geom('geom1').feature('wp1').geom.feature('uni3').selection('input').set({'arrec2'});
...
model.component('comp1').geom('geom1').feature('wp1').geom.feature('rot4').selection('input').set({'uni3'});
model.component('comp1').geom('geom1').feature('wp1').geom.feature('rot4').set('rot', 'theta');
model.component('comp1').geom('geom1').feature('wp1').geom.feature('rot4').set('pos', {'arrange_size-unit_size/2' '0'});
model.component('comp1').geom('geom1').feature('wp1').geom.feature('rot4').setIndex('pos', 'arrange_size-unit_size/2', 1);
...
model.component('comp1').geom('geom1').feature('wp1').geom.feature('sq1').set('size', '4*arrange_size');
model.component('comp1').geom('geom1').feature('wp1').geom.feature('sq1').set('pos', {'arrange_size-unit_size/2' '0'});
model.component('comp1').geom('geom1').feature('wp1').geom.feature('sq1').setIndex('pos', 'arrange_size-unit_size/2', 1);
...
model.component('comp1').geom('geom1').feature('wp1').geom.feature('uni4').selection('input').set({'dif3' num2str(r-3,'%i') num2str(r-2,'%i') num2str(r-1,'%i') num2str(r,'%i')});
model.component('comp1').geom('geom1').feature('wp1').geom.feature('uni4').set('intbnd', false);
model.component('comp1').geom('geom1').feature('wp1').geom.feature('uni4').set('keep', false);
model.component('comp1').geom('geom1').feature('wp1').geom.run('uni3');
...
% model.component('comp1').geom('geom1').feature('wp1').geom.feature('fil1').selection('point').set('uni4',[1:num_points/2]);
